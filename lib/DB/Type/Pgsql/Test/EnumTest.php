...
class DB_Type_Pgsql_Test_EnumTest extends DB_Type_Test_Util_TypeTestCase
{
	...
	protected function _getPairsOutput()
	{
		return array(
			array(
				new DB_Type_Pgsql_Enum(array('one','two','three')),
				'one',
				'one',
				"ENUM",
			),
			array(
				new DB_Type_Pgsql_Enum(array('one','two','three')),
				'five',
				new DB_Type_Exception_Enum(
					new DB_Type_Pgsql_Enum(
						array('one', 'two', 'three')
					),'five'),
				"ENUM",
			),
